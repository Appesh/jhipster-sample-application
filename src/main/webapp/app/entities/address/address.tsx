            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('jhipsterSampleApplicationApp.address.home.search')}
                />
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('address1')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.address.address1">Address 1</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('address2')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.address.address2">Address 2</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('city')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.address.city">City</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('postcode')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.address.postcode">Postcode</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('country')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.address.country">Country</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.address.customer">Customer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
