  ...
  return (
    <div>
      <h2 id="category-heading">
        <Translate contentKey="jhipsterSampleApplicationApp.category.home.title">Categories</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterSampleApplicationApp.category.home.createLabel">Create new Category</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('jhipsterSampleApplicationApp.category.home.search')}
                />
        ...
        {categoryList && categoryList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.category.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.category.parent">Parent</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {categoryList.map((category, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`jhipsterSampleApplicationApp.CategoryStatus.${category.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.category.home.notFound">No Categories found</Translate>
            </div>
          )
        )}
      </div>
