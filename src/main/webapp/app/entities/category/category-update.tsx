  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.category.home.createOrEditLabel">
            <Translate contentKey="jhipsterSampleApplicationApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : categoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="AVAILABLE">{translate('jhipsterSampleApplicationApp.CategoryStatus.AVAILABLE')}</option>
                  <option value="RESTRICTED">{translate('jhipsterSampleApplicationApp.CategoryStatus.RESTRICTED')}</option>
                  <option value="DISABLED">{translate('jhipsterSampleApplicationApp.CategoryStatus.DISABLED')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
