            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('jhipsterSampleApplicationApp.customer.home.search')}
                />
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('email')}>
                  <Translate contentKey="jhipsterSampleApplicationApp.customer.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                </th>
