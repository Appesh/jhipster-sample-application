...
import com.guitarcenter.lessons.domain.Category;
import com.guitarcenter.lessons.domain.enumeration.CategoryStatus;
import com.guitarcenter.lessons.repository.CategoryRepository;
import com.guitarcenter.lessons.repository.search.CategorySearchRepository;
import com.guitarcenter.lessons.service.CategoryService;
...
public class CategoryResourceIT {
     ...
     *
     * @see com.guitarcenter.lessons.repository.search.CategorySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllCategoriesWithEagerRelationshipsIsEnabled() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories?eagerload=true")).andExpect(status().isOk());
    ...
    public void searchCategory() throws Exception {
        ...
        // Search the category
        restCategoryMockMvc
            .perform(get("/api/_search/categories?query=id:" + category.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(category.getId().intValue())))
            .andExpect(jsonPath("$.[*].description").value(hasItem(DEFAULT_DESCRIPTION)))
